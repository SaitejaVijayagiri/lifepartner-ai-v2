...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    const title = category === 'location'
        ? `${displayValue} Matrimony - Free Matchmaking in ${displayValue} | LifePartner AI`
        : `${displayValue} Matrimony Profiles - 100% Free | LifePartner AI`;

    const description = `Find Verified ${displayValue} Brides & Grooms. 100% Free Matrimony App. No Payment Required. Safe, Secure, and AI-Powered Matchmaking in ${displayValue}.`;
