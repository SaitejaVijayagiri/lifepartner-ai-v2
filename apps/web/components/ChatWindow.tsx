                                        ...
                                        >
                                            ...
                                            {!isMe && (
                                                <button
                                                    ...
                                                    className="p-1 text-gray-400 hover:text-red-500 rounded-full transition-colors cursor-pointer flex items-center gap-1"
                                                    title="Report & Block"
                                                >
                                                    <Flag size={13} />
                                                    <span className="text-[10px] font-semibold text-gray-500">Report</span>
                                                </button>
                                            )}
                                        </div>
                                    )}
