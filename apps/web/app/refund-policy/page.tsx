            ...
            <div className="prose prose-indigo max-w-none text-gray-700 space-y-6">
                ...
                <section>
                    ...
                    <p>
                        ...
                        If the amount is deducted and Coins are not credited within 24 hours, please contact us at <a href="mailto:support@lifepartner.ai" className="text-indigo-600 hover:underline">support@lifepartner.ai</a> with your Transaction ID, and we will manually process the refund or credit.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        For any billing related queries, please contact our support team at <a href="mailto:support@lifepartner.ai" className="text-indigo-600 hover:underline">support@lifepartner.ai</a>.
                    </p>
                </section>
            </div>
        </div>
