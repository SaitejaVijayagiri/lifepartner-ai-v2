                    ...
                    <div className="max-h-[400px] overflow-y-auto">
                        {notifications.length === 0 ? (
                            ...
                            notifications.map((notif: any) => (
                                <div key={notif.id} className={`p-4 border-b border-gray-50 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors ${!notif.is_read ? 'bg-indigo-50/50 dark:bg-indigo-900/30' : ''}`}>
